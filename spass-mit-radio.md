...
## @fullscreen
Schicke Herzen per Funk an andere micro:bits! 
...
Danach füge einen ``||basic:Bildschirminhalt löschen||`` Block ein.
## 
Alle micro:bits in der Nähe senden und empfangen auf der gleichen Funkgruppe. 
Füge am Anfang – in den ``||basic:beim Start||``-Block - einen ``||radio:setze Funkgruppe||`` Block ein.
